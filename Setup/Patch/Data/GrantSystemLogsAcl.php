...
/**
 * Grants WebSupportDesk_SystemLogs::systemlogs to Administrators and roles that already
 * have other WebSupportDesk admin resources.
 */
class GrantSystemLogsAcl implements DataPatchInterface
{
    private const RESOURCE_ID = 'WebSupportDesk_SystemLogs::systemlogs';
